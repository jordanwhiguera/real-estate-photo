    ...
    <Container>
      ...
      <div className="py-10">
        ...
        <div className="text-sm md:text-base text-black space-y-4">
          ...
          <p>
            This Media Agreement (the "Agreement") sets out the terms under
            which <strong>Open Home Media LLC</strong> ("Open Home Media" or
            "Licensor") provides photos, videos, virtual tours, drone footage,
            or any other media (collectively, "Media") to any person or entity
            ("Client"). This Agreement ensures clear ownership, usage rights,
