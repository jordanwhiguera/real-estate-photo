    ...
    <Container className="">
      ...
      <div className="flex flex-col md:flex-row items-stretch md:space-x-4 pb-16">
        ...
        <div className="bg-black rounded-3xl text-white p-4 flex flex-col justify-between md:w-1/3">
          <p className="mb-4">
            Jordan Higuera is a professional photographer and videographer based
            in Port Saint Lucie. He specializes in real estate photography and
        ...
        <div className="md:w-2/3 pt-4 md:pt-0">
          <img
            src="/images/home-1.jpg" // Replace with the actual path to your image
            alt="Photographer"
